...
export class OtterBondingCalculator extends ethereum.SmartContract {
  static bind(address: Address): OtterBondingCalculator {
    return new OtterBondingCalculator("OtterBondingCalculator", address);
  }
